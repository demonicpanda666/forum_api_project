const ThreadRepositoryPostgres = require('../Thread_Repository_Postgress');
const ThreadRepository = require('../../../Domains/threads/Thread_Repository');
const ThreadsTableTestHelper = require('../../../../tests/ThreadsTableTestHelper');
const pool = require('../../database/postgres/pool');
const AddThread = require('../../../Domains/threads/entities/Create_Thread');
  ...
  describe('behavior test', () => {
    ...
    describe('addThread function', () => {
      it('should persist new thread and return added thread correctly', async () => {
        ...
        const thread = await ThreadsTableTestHelper.findThreadbyId('thread-h_123456789abcdef');
